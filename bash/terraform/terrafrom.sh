#!bin/bash
if [ -f /etc/redhat-release -o /etc/system-release ]; then
...
sudo apt-add-repository "deb [arch=$(dpkg --print-architecture)] https://apt.releases.hashicorp.com $(lsb_release -
cs) main"
